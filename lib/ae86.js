...
AE86.prototype._loadTemplates = function (templateDir, engine) {
    var templates = {}, encoding = this.options.encoding, that = this;
...
AE86.prototype._writePages = function (layouts, partials, params, engine) {
    var pagesDir = this.options.pages, outDir = this.options.out, mode = this.options.mode,
        encoding = this.options.encoding, that = this;
...
AE86.prototype.generate = function (engine) {
    ...
    layouts = this._loadTemplates(this.options.layouts, engine);
    
    console.log('Loading partials...');
    partials = this._loadTemplates(this.options.partials, engine);
    
    console.log('Writing pages...');
    this._writePages(layouts, partials, this.options.params, engine);
};
